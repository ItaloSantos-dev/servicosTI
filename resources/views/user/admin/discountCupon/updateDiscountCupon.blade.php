...
@section('content')
    <main class="">
        ...
        <div class="container max-w-7xl mx-auto px-4">
            ...
            <form  action="{{route('admin.discountCupons.update', $discountCupon->id)}}" method="POST">
                @csrf
                @method('PUT')
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                            ...
                            <div class="mb-6">
                                ...
                                <input value="{{$discountCupon->slug}}" name="slug" id="slug" type="text" class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none">
                            ...
                            <div class="grid grid-cols-2 gap-5 ">
                                <div>
                                    ...
                                    <input name="amount" id="amount" type="number" step="1" value="{{$discountCupon->amount}}"
                                ...
                                <div>
                                    ...
                                    <input value="{{$discountCupon->minimum_amount}}" autocomplete="new-password" name="minimum_amount" id="amount" type="number" step="1"
                                           class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none">
                                </div>
                                <div class="mb-6">
                                    ...
                                    <input class="w-6 h-6 scale:120" name="active" id=active"" type="checkbox" {{$discountCupon->active?'checked':''}}>
                                </div>
                            </div>
                        </div>
                    </div>
