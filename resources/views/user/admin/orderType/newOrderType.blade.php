...
@section('content')
    <main class="">
        ...
        <div class="container max-w-7xl mx-auto px-4">
            ...
            <form  action="{{route('admin.orderTypes.store')}}" method="POST">
                @csrf
                <div class=" gap-8">
                    <div class="lg:col-span-2 space-y-8">
                        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                            ...
                            <div class="mb-6">
                                ...
                                <input type="text" name="name" class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none" id="name">
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <input type="number" step="0.01" class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none" name="amount" id="amount">
                            </div>
                            <div class="space-y-4">
                                <button
