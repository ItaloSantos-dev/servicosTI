...
@section('title', 'Criar Tipo de pedido')
...
@section('content')
    <main class="">
        ...
        <div class="container max-w-7xl mx-auto px-4">
            ...
            <form  action="{{route('admin.orderTypes.update', $orderType->id)}}" method="POST">
                @csrf
                @method('PUT')
                <div class=" gap-8">
                    <div class="lg:col-span-2 space-y-8">
                        <div class="bg-white rounded-2xl shadow-lg border border-gray-200 p-6">
                            ...
                            <div class="mb-6">
                                ...
                                <input value="{{$orderType->name}}" type="text" name="name" class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none" id="name">
                            </div>
                            ...
                            <div class="mb-6">
                                ...
                                <input value="{{$orderType->amount}}" type="number" step="0.01" class="w-full border border-gray-300 rounded-xl px-4 py-3 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all duration-200 resize-none" name="amount" id="amount">
                            </div>
                            <div class="mb-6">
                                <label for="address" class="block text-sm font-semibold text-gray-700 mb-2">
                                    Ativo *
                                </label>
                                <input class="w-6 h-6 scale:120" name="active" id=active"" type="checkbox" {{$orderType->active?'checked':''}}>
                            </div>
                            <div class="space-y-4">
                                <button
