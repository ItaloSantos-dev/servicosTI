...
<main class="container mx-auto">
    ...
    <div class='container flex  mx-auto w-100 justify-center '>
        <div class='flex gap-x-15 text-gray-200 text-2xl'>
            <a href="" class='cursor-pointer hover:bg-linear-to-t from-purple-600 to-blue-700 p-3  transition-all hover:scale-105 hover:shadow-lg hover:backdrop-blur-2xl hover:rounded-2xl btnBottom'>Cadastrar-se</a>
